...
const PISOS = {
  ...
  <g filter="url(#ruido)">
    ...
    <path
      d="M79 81h108M322 81h111M79 429h108M322 429h111"
      stroke="#d3d9d6"
      stroke-width="4"
  ...
  <g filter="url(#ruido)">
    ...
    <path
      d="M160 160 352 352M352 160 160 352"
      stroke="#3c797c"
      stroke-width="6"
      opacity=".42"
    />
    ...
    <path
      d="M94 94h67M351 94h67M94 418h67M351 418h67"
      stroke="#c89d2d"
      stroke-width="8"
...
async function gerarPisos() {
  ...
  console.log(
    [
      "",
      "Pisos da Instalação Subterrânea concluídos.",
      `Criados: ${criados}.`,
...
gerarPisos().catch(
  (erro) => {
    console.error(
      "Não foi possível gerar os pisos da Instalação Subterrânea.",
    );
